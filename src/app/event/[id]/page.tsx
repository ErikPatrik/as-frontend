...
import { Seacrh } from '../../../components/site/Search'
...
const Page = async ({ params }: Props) => {
    ...
    return(
        <main className="text-center mx-auto max-w-lg p-5 bg-red-900">
            <header>
            ...
            <Seacrh id={eventItem.id} />

            <footer className="mt-5 text-sm">By Erik</footer>
        </main>
    )
}
